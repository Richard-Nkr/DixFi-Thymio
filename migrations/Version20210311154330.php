 ...
 */
final class Version20210311154330 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat ADD CONSTRAINT FK_659DF2AA41807E1D FOREIGN KEY (teacher_id) REFERENCES teacher (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE `student_group` ADD CONSTRAINT FK_E5F73D581A9A7125 FOREIGN KEY (chat_id) REFERENCES chat (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE `teacher` ADD CONSTRAINT FK_B0F6A6D51A9A7125 FOREIGN KEY (chat_id) REFERENCES chat (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
